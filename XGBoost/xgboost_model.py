...
X = data.drop(columns=['AFL_data','KLEE_data','trace_length_max','global_nesting_depth_max','call_depth_max',
                         'no_of_local_variables_max','taintCount_max','trace_length_median','global_nesting_depth_median','call_depth_median',
                         'no_of_local_variables_median','taintCount_median','trace_length_min','global_nesting_depth_min','call_depth_min','no_of_local_variables_min','taintCount_min'])
y_AFL = data['AFL_data']
