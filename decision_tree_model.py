...
X = data.drop(columns=['AFL_data','KLEE_data','trace_length_mean','global_nesting_depth_mean','call_depth_mean',
                         ...
                         'no_of_local_variables_min','taintCount_min','taintCount_max'])
y_AFL = data['AFL_data']
...
export_graphviz(clf_AFL, out_file='AFL_tree.dot',   
                         ...
                         class_names=['0','1'],feature_names=['trace_length_mean','global_nesting_depth_mean','call_depth_mean','no_of_local_variables_mean'])  
